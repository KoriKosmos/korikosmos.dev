 ...
 *
 * The choice is stored twice on the client: in localStorage (what ThemeBar
 * reads back to highlight the active swatch) and in a cookie. Only the cookie
 * is visible to the server, and that is the point — `ModernLayout` renders
