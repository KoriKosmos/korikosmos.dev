...
- **Smooth theme reveals**: I keep storage writes outside the browser's snapshot pause and change the selected swatch with the page colours. The circular reveal keeps its original timing, handles interruptions and respects reduced motion; browsers without view transitions get a colour fade.
